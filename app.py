...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            # Footer text
            st.markdown("""
            <hr style="margin-top:40px; margin-bottom:20px; border: 0; height: 1px; background: #333;">
            <p style='text-align: center; font-size: 15px; color: #BBBBBB;'>
                🚀 <b>Smart AI Resume Analyzer</b> &nbsp;|&nbsp; Built with <b>Streamlit</b> &nbsp;|&nbsp; AI powered insights
            </p>

            <p style='text-align: center; font-size: 14px;'>
                Developed by 
                <a href="https://www.linkedin.com/in/rishavv-raj" target="_blank" style='text-decoration: none; color: #4DA6FF;'>
                    <b>Rishav Raj</b>
                </a> 
                &nbsp;|&nbsp;
                <a href="https://github.com/RishavRaj1604" target="_blank" style='text-decoration: none; color: #4DA6FF;'>
                    GitHub
                </a>
            </p>

            <p style='text-align: center; font-size: 12px; color: #888888;'>
                © 2026 Rishav Raj. All rights reserved.
            </p>
            """, unsafe_allow_html=True)
    ...
    st.session_state.form_data['skills_categories']['tools']),
        ...
        if st.button("Generate Resume 📄", type="primary"):
            ...
            print("Email input value:", st.session_state.form_data['personal_info']['email'])
            print("Session email_input:", st.session_state.get('email_input', ''))
...
<div class="profile-section">
    <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/RishavRaj1604'}"
         alt="Rishav Raj"
         class="profile-image"
         onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/RishavRaj1604';">

    <h2 class="profile-name">Rishav Raj</h2>
    <p class="profile-title">AI & Machine Learning Engineer | Full Stack Developer</p>

    <div class="social-links">
        <a href="https://github.com/RishavRaj1604" class="social-link" target="_blank">
            <i class="fab fa-github"></i>
        </a>
        <a href="https://www.linkedin.com/in/rishavv-raj" class="social-link" target="_blank">
            <i class="fab fa-linkedin"></i>
        </a>
        <a href="mailto:rishavraj.0416@gmail.com" class="social-link" target="_blank">
            <i class="fas fa-envelope"></i>
        </a>
    </div>

    <p class="bio-text">
        Hello! I'm Rishav, an AI & Machine Learning Engineer passionate about building intelligent systems 
        that solve real-world problems. I developed Smart Resume AI to help job seekers optimize their resumes 
        using data-driven insights, ATS analysis, and modern NLP techniques.
        <br><br>
        With a strong background in Artificial Intelligence, Machine Learning, and Full Stack Development, 
        I focus on creating scalable, practical, and impactful applications that bridge the gap between 
